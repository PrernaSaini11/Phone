...
public class signIn extends AppCompatActivity{
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_sign_in);   startauthentication();
            SharedPreferences mPreferences;
            mPreferences = signIn.this.getSharedPreferences("User", MODE_PRIVATE);
        ...
        public void startauthentication(){
            ...
            if(temporary!= null && !temporary.isEmpty()){
                ...
                Intent y = new Intent(signIn.this, MainActivity.class);
