package com.prerna.saini.phone2;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main);      // Restore instance state
                            ...
                            myRef.child("users").child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot snapshot) {
                                    if (snapshot.getValue() != null) {
                                        ...
                                        Intent y = new Intent(MainActivity.this, signIn.class);
                                        ...
                                        myRef.child("users").child(userID).child("images").setValue("uploaded_files");
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        switch (uiState) {
            ...
            case STATE_VERIFY_SUCCESS:
                ...
                Toast.makeText(MainActivity.this, "verification success", Toast.LENGTH_LONG).show();
